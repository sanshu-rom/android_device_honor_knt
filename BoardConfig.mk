...
# Assert
TARGET_OTA_ASSERT_DEVICE := hi3650,knt,KNT,KNT-AL10,KNT-AL20,KNT-TL10,KNT-UL10
...
TARGET_KERNEL_SOURCE := kernel/honor/hi3650
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 2015182848
BOARD_USERDATAIMAGE_PARTITION_SIZE := 26933706752
...
BOARD_RIL_CLASS := ../../../device/honor/knt/ril
...
TARGET_LIBINIT_DEFINES_FILE := $(LOCAL_PATH)/init/init_knt.cpp

# Sepolicy
BOARD_SEPOLICY_DIRS += \
	device/honor/knt/sepolicy
...
-include vendor/honor/knt/BoardConfigVendor.mk
